...
public class WaveLoadingView extends View{
    ...
    private int mRoundRectangleXY , mRoundRectangleX, mRoundRectangleY;
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mRoundRectangleX = attributes.getInteger(R.styleable.WaveLoadingView_wlv_round_rectangle_x, DEFAULT_ROUND_RECTANGLE_X_AND_Y);
        mRoundRectangleY = attributes.getInteger(R.styleable.WaveLoadingView_wlv_round_rectangle_y, DEFAULT_ROUND_RECTANGLE_X_AND_Y);
                ...
                case 3:
                    if (mIsRoundRectangle) {
                        if (borderWidth > 0) {
                            ...
                            RectF rect = new RectF(borderWidth /2f,
                                    borderWidth / 2f,
                                    getWidth() - borderWidth / 2f - 0.5f,
                                    getHeight() - borderWidth / 2f - 0.5f);
                           ...
                           /* canvas.drawOval(borderWidth /2f, borderWidth / 2f, getWidth() - borderWidth / 2f - 0.5f, getHeight() - borderWidth / 2f - 0.5f,
                                    mBorderPaint);
                            canvas.drawOval(borderWidth /2f, borderWidth / 2f, getWidth() - borderWidth / 2f - 0.5f, getHeight() - borderWidth / 2f - 0.5f,
                                    mWaveBgPaint);
                            canvas.drawOval(borderWidth /2f, borderWidth / 2f, getWidth() - borderWidth / 2f - 0.5f, getHeight() - borderWidth / 2f - 0.5f,
